...
ROUTE_PLAN_FORWARD         = [ 1000, 800,  500,   1000,   200, 800]
ROUTE_PLAN_TRANSLATION     = [-1200,  0,   800,    700,    800, -800]   #pos = left, neg = right
ROUTE_PLAN_THETA           = [    -1,  5,   -5,    0,    -5,   3]   #pos = left, neg = right
ROUTE_PLAN_TIME            = [    0,   7,    10,    5,    12,   3]
#---微調站姿開關---#
