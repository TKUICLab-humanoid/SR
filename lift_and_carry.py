...
ROUTE_PLAN_FORWARD         = [ 0,     1000,   0,   300,   0,     0]
ROUTE_PLAN_TRANSLATION     = [ 1200,   600, -500,  -500,  -800, -500]   #pos = left, neg = right
ROUTE_PLAN_THETA           = [   -2,   -3,   -6,     0,   6,    4]   #pos = left, neg = right
ROUTE_PLAN_TIME            = [    0,   4,    5,     13,    5,    4]
#---微調站姿開關---#
