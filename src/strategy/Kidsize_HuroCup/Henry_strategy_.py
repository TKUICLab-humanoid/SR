...
#///////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
                if Ladder.Walk == False and Ladder.Progress == False:
                    send.sendBodyAuto(200,0,0,0,1,0)                                                                    #走路速度（進退,平移,用不到,左右轉角度,0/1（走一步/持續走））
                    time.sleep(1)
                    Ladder.Walk = True
                    Ladder.Progress = True
                    Ladder.Times += 1

                elif Ladder.Walk == True and Ladder.Progress == True:
                    if Ladder.Times ==1:
                        Ladder.Find_ladder()                                                                                            #呼叫SR_API的find_board
                        Ladder.Ladder_revision()

                elif Ladder.Walk == False and Ladder.Progress == True:
